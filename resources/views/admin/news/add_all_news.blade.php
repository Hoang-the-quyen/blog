    ...
    <div class="app">
        <div class="container">
            ...
            <div class="main__content">
              <h1 style="margin:20px">Add news</h1>
              <form method="post" action="{{route ('save_news')}}" enctype="multipart/form-data" novalidate="novalidate" class="forms-sample">
                @csrf
              ...
              {{-- table --}}
              <h1 style="margin:20px">all news</h1>
              <table class="table">
                <thead>
                  <tr>
                    <th scope="col">#</th>
                  ...
                  @foreach ($show as $show)
                    <tr>
                      ...
                      <td>
                        ...
                        <a href="{{ route('delete_news', ['id' => $show->id]) }}" class="btn btn-primary">Delete</a>
                      </td>
                    </tr>
                  @endforeach
                </tbody>
