            ...
            <div class="container">
                <nav class="navbar navbar-inverse navbar-toggleable-md">
                    ...
                    <div class="collapse navbar-collapse justify-content-md-center" id="Forest Timemenu">
                        <ul class="navbar-nav">
                            <li class="nav-item">
                                <a class="nav-link color-green-hover" href="garden-index.html">Mới nhất</a>
                            </li>
                            @foreach ($show_cate as $show)
                                <li class="nav-item">
                                    <a class="nav-link color-green-hover" href="garden-category.html">{{$show->name}}</a>
                                </li>
                            @endforeach
                        </ul>
                    </div>
